# lulu-learn · Lulu 的学习工坊

> 把一场 3 小时的讲座,做成一份可回访的学习资产。
...
```bash
npx -y skills add ilulu66/lulu-learn-skills -g --all
```
...
`-calibrate`(校准源降级链+主题热词表)· `-map`(知识原则/学习路线图深加工)· `-diff`(同一讲者跨期对比)· 转写扩源 · 多路录音判重
